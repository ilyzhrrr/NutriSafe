...
export default function DataAlergi() {
  ...
  return (
    <div className="flex min-h-screen bg-[#F0FFF4] font-sans">
      <SidebarSekolah />
      <main className="flex-1 p-4 sm:p-6 pt-16 lg:pt-6 min-w-0">
        <header className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-6">
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              <h2 className="text-xl sm:text-2xl font-black text-[#166534]">Dashboard Sekolah</h2>
            </div>
            <p className="text-base sm:text-lg font-bold text-[#166534]">Rekap Data Alergi Siswa</p>
          </div>
          <div className="sm:text-right">
            <p className="text-xs sm:text-sm font-bold text-gray-800">{new Date().toLocaleDateString('id-ID', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })}</p>
          </div>
        </header>

        <div className="bg-white p-5 sm:p-8 rounded-3xl shadow-sm border border-gray-100 mt-4">
