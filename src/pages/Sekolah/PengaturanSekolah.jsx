    ...
    <div className="flex min-h-screen bg-[#F0FFF4] font-sans">
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        <div className="max-w-4xl mx-auto mt-6">
          <h2 className="text-4xl font-black text-[#166534] mb-8">Pengaturan</h2>
            ...
            <div className="bg-white rounded-3xl shadow-sm p-8">
              ...
              <div className="space-y-4 max-w-md">
                <div>
                  ...
                  <input type="password" placeholder="••••••••" className="w-full bg-gray-50 border border-gray-200 p-3 rounded-xl outline-none focus:border-green-500 font-bold" />
                </div>
                <div>
                  <label className="block text-xs font-bold text-gray-600 mb-1">Password Baru</label>
                  <input type="password" placeholder="Minimal 8 karakter" className="w-full bg-gray-50 border border-gray-200 p-3 rounded-xl outline-none focus:border-green-500 font-bold" />
                </div>
                <button className="bg-[#22C55E] text-white px-6 py-2.5 rounded-xl font-bold hover:bg-green-600 transition mt-2">
                  Ganti Password
                </button>
              </div>
            </div>
