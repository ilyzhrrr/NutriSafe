      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8 pt-16 lg:pt-8 overflow-y-auto min-w-0">
        <div className="max-w-5xl mx-auto">
          ...
          {loading ? (
            ...
            groups.map((group, i) => (
              <div key={i} className="bg-[#C6F6D5] p-5 sm:p-8 rounded-3xl sm:rounded-[32px] mb-6">
                ...
                <h3 className="text-xl sm:text-2xl font-black mb-6 text-center text-gray-800">Menu Makanan Khusus Siswa Alergi</h3>
