            ...
            <div className="bg-white rounded-3xl shadow-sm p-8">
              ...
              <form onSubmit={handleChangePassword} className="space-y-4 max-w-md">
                <div>
                  ...
                  <div className="relative">
                    <input type={showOld ? 'text' : 'password'} placeholder="••••••••" value={form.old_password}
                      ...
                      className="w-full bg-gray-50 border border-gray-200 p-3 pr-11 rounded-xl outline-none focus:border-orange-500 font-bold" />
                ...
                <button type="submit" disabled={saving}
                  className="bg-[#2563EB] text-white px-6 py-2.5 rounded-xl font-bold hover:bg-blue-700 transition mt-2 disabled:opacity-60">
