...
>>>>>>> c122b954c9754db66f811f2eb45621e0cfddbb38
  ...
  const handleResetPassword = () => {
    ...
    setTimeout(() => {
      setLoading(false)
      setView('login') // Kembali ke form login
      setShowSuccessToast(true) // Munculkan notifikasi sukses
...
<<<<<<< HEAD
        <img
          src="/utama.png"
          alt="Ilustrasi Utama"
          className="w-4/5 rounded-xl mb-8 shadow-lg bg-white"
        />
        <p className="text-center mb-6 px-4 text-sm">
          Membantu sekolah, mitra, dan masyarakat dalam memantau serta
          melaporkan keamanan dan kualitas makanan siswa
        </p>
            ...
            <div className="bg-white p-10 rounded-2xl shadow-sm w-3/5 max-w-md">
              ...
              <div className="mb-8">
                ...
                <div className="text-right mt-2">
                  <span onClick={() => {setView('forgot'); setError('');}} className="text-[#3B82F6] text-xs font-bold cursor-pointer hover:underline">
                    Lupa Password?
                  </span>
                </div>
              </div>
          ...
          <>
            ...
            <div className="bg-white p-10 rounded-2xl shadow-sm w-3/5 max-w-md">
              ...
              <p className="text-center mt-2 text-xs">
                <span onClick={() => {setView('login'); setError('');}} className="text-gray-400 cursor-pointer hover:text-gray-600 hover:underline">
